...
public class OrderDetailActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		qrCodeImageUrl = "https://api.qrserver.com/v1/create-qr-code/?size=300x300&data="
				+ orderObj.qrCode;
	...
	void initializeOrderInfo() {
		...
		tvOrderResturantName.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.putExtra("resturant_address", orderObj.products.get(0)
						.getName().trim());
		...
		tv_eshop_ResturantName.setOnClickListener(new OnClickListener() {
		...
		try {
			tvOrderId.setTypeface(Helper.getSharedHelper().boldFont);
		...
		if (orderObj.outletAddr != null) {
			String resturantAddress = "<b>Address</b>&nbsp;&nbsp;"
					+ orderObj.outletAddr;
		...
		// {
		// String discount="<b>Discount </b> " +Helper.getSharedHelper()
		// .getCurrencySymbol(selectedCurrencyCode)+orderObj.products.get(0).offpeakDiscount;
		String discount = "<b>Discount </b>&nbsp; "
				+ orderObj.products.get(0).offpeakDiscount + "%";
