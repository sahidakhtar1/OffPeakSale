...
public class BezierTranslationAnimation extends TranslateAnimation {
    ...
    public BezierTranslationAnimation(float fromXDelta, float toXDelta,float fromYDelta, float toYDelta, float bezierXDelta, float bezierYDelta) {
