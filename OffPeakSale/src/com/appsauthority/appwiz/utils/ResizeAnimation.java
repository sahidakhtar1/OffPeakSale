...
public class ResizeAnimation extends Animation {
	...
	public ResizeAnimation(View view, int originalHeight, int targetHeight,
			boolean down) {
		this.view = view;
	...
	protected void applyTransformation(float interpolatedTime, Transformation t) {
		...
		// The new view height is based on start height plus the height
		// increment
		...
		if (adjacentView != null) {
			...
			adjacentView.getLayoutParams().height = view.getLayoutParams().height
					+ adjacentHeightIncrement;
